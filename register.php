...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light mt-5 mb-3" style="background-color: #F6F4F4;">

        <a class="navbar-brand" href="index.php"> <img src="images/favicon.svg" style="max-width: 4.5rem;"> Auctify</a>
    ...
    <div class="container" id="container" style="width: 65vw; height: 80vh;">
        <div class="form-container sign-up-container">
            ...
            <form method="POST" action="signup.php" onSubmit="return checkUserInputs();">
                ...
                <h3 class='text-danger mb-3 mt-2'><?php echo $msg;?></h3>
