...
<body>
	<section id="search-hero">
		<div class="mt-5 text-center">
			...
			<div class="mt-5 text-center"><a href="#browse" id="scrollClick" class="smoothScroll"><span class="display-1 text-light text-center">&#8659;</span></a></div>
		</div>
	</section>

	<nav class="navbar sticky-top navbar-expand-md navbar-dark bg-black px-5 mb-5" style="height: 15vh;">
